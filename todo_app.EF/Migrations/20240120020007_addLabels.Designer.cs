...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("todo_app.core.Label", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("todo_app.core.Models.Data.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("todo_app.core.Models.Auth.UserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("todo_app.core.Label", b =>
                {
                    b.HasOne("todo_app.core.Models.Auth.UserModel", "User")
                        .WithMany("Labels")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("todo_app.core.LabelNote", b =>
                {
                    b.HasOne("todo_app.core.Label", "Label")
                        .WithMany("LabelNotes")
                        .HasForeignKey("LabelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("todo_app.core.Models.Data.Note", "Note")
                        .WithMany("LabelNotes")
            ...
            modelBuilder.Entity("todo_app.core.LabelTodo", b =>
                {
                    ...
                    b.HasOne("todo_app.core.Models.Data.Todo", "Todo")
                        .WithMany("LabelTodos")
